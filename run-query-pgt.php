...
$result = $db->get();
	...
	echo "<script>$('#popup-wrap').hide();</script><div id='ok'>رکورد مورد نظر با موفقیت اضافه شد</div>";
	}
	}
	//Edit table record
	if ($whatwork=="edit"){
	...
	echo "<script>$('#popup-wrap').hide();</script><div id='ok'>رکورد مورد نظر با موفقیت ویرایش شد</div>";
	}
	}
	//delete table record
	if ($whatwork=="delete"){
	...
	echo "<script>$('#popup-wrap').hide();</script><div id='ok'>رکورد مورد نظر با موفقیت حذف شد</div>";
	}
